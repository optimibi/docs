...
|» componentId|body|string| no |none|
|» componentTitle|body|string| no |none|
...
|»»» comparator|body|string| no |none|
|»»» value|body|[integer]| no |none|
|»»» match|body|string| no |none|
...
|»»» datafor.query.pick.row|body|string| yes |none|
|»»» datafor.secret.appKey|body|string| yes |none|
|»»» datafor.olap.result.formatter|body|string| yes |none|
|»»» datafor.client.timezone|body|string| yes |none|
|»»» datafor.client.locale|body|string| yes |none|
|»»» datafor.source.format|body|string| yes |none|
