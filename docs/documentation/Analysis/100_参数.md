...
3. In the **"Manage Parameters"** window that appears, fill in the following information:
   ...
   <div align="left"><img src="./images/1722160279827.png"  width="60%" /></div>
...
[Switching Tabs with Parameters](https://help.optimibi.com/documentation/Visualization/Parameter-Driven-Tab-Switching/)
